...
"""
A class that yields examples of a simplified span corruption objective.

--------------
Vocabulary Specification

Vocabulary should be accessible via two dictionaries:
